...
import pizzaAmericaine from  '../..//assets/pizza final/pizza americaine v1.png'
    ...
    return (
        <main id="home">
            ...
            <div className='section2__box'>
                    <span>
                        <h2>
                        Bienvenue chez Le 45 Pizza ! Retrouvez-nous dans notre restaurant à Meudon-la-forêt
                        </h2>
                    </span>
                    <span>
                        <p>
                        Au 45 Pizza, vous pourrez retrouver une cuisine de qualité au meilleur prix, fait maison et avec des ingrédients frais . Testez ainsi nos délicieuses pizzas, nos croques, nos Paninis kebab ou bien laissez-vous tenter par nos délicieux desserts. Vivez l’expérience en livraison ou à emporter ! A bientôt chez Le 45 pizza !
                        </p>
                    </span>
           ...
           <section id='section5' className='section5'>
            ...
            <div className='plan__box'>
                ...
                <div className='plan__btn'><OrderButton lien={"https://www.google.com/maps/dir//Le+45+45+Av.+du+G%C3%A9n%C3%A9ral+de+Gaulle+92360+Meudon/@48.7866275,2.2247871,14z/data=!4m8!4m7!1m0!1m5!1m1!1s0x47e67b7c675ae175:0x95c398b15a53dc8e!2m2!1d2.2247871!2d48.7866275?entry=ttu"} texte={"Itinéraire"}/></div>
            </div>
